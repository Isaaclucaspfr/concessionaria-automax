    ...
    <div className="min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {carrosDestaque.map((carro, index) => (
                <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                  ...
                  <div className="p-4">
                    <h3 className="text-lg font-semibold mb-2">{carro.marca} {carro.modelo}</h3>
                    <p className="text-gray-600 mb-1 text-sm">Ano: {carro.ano}</p>
                    <p className="text-gray-600 mb-2 text-sm">KM: {carro.km?.toLocaleString('pt-BR')}</p>
                    <p className="text-xl font-bold text-blue-600">{formatPrice(carro.preco)}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="py-12 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Pronto para Encontrar Seu Próximo Carro?</h2>
